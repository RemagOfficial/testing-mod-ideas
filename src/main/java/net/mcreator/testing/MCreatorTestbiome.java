...
public class MCreatorTestbiome extends Elementstesting.ModElement {

	@ObjectHolder("testing:testbiome")
	public static final CustomBiome biome = null;

	public MCreatorTestbiome(Elementstesting instance) {
		super(instance, 5);
	}
	...
	static class CustomBiome extends Biome {
		...
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.5f).depth(0.1f).scale(0.2f).temperature(0.5f).precipitation(Biome.RainType.RAIN)
					...
					.surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(MCreatorTestinggithub.block.getDefaultState(),
							MCreatorTestinggithub.block.getDefaultState(), MCreatorTestinggithub.block.getDefaultState())));
	...
	static class CustomTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
		...
		public boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldgen, Random rand, BlockPos position, MutableBoundingBox bbox) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == MCreatorTestinggithub.block.getDefaultState().getBlock()
							|| ground == MCreatorTestinggithub.block.getDefaultState().getBlock())
							&& (ground2 == MCreatorTestinggithub.block.getDefaultState().getBlock()
									|| ground2 == MCreatorTestinggithub.block.getDefaultState().getBlock())))
						return false;

					BlockState state = world.getBlockState(position.down());
					if (position.getY() < world.getHeight() - height - 1) {
						setTreeBlockState(changedBlocks, world, position.down(), MCreatorTestinggithub.block.getDefaultState(), bbox);
								...
								for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
									...
									if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) {
										...
										if (state.getBlock().isAir(state, world, blockpos) || state.getMaterial().blocksMovement()
												...
												|| state.getBlock() == MCreatorTestinggithub.block.getDefaultState().getBlock()
												|| state.getBlock() == MCreatorTestinggithub.block.getDefaultState().getBlock()) {
											setTreeBlockState(changedBlocks, world, blockpos, MCreatorTestinggithub.block.getDefaultState(), bbox);
										}
									}
								}
							}
						...
						for (int genh = 0; genh < height; genh++) {
							...
							setTreeBlockState(changedBlocks, world, genhPos, MCreatorTestinggithub.block.getDefaultState(), bbox);
								...
								for (Direction Direction : Direction.Plane.HORIZONTAL) {
									if (rand.nextInt(4 - hlevel) == 0) {
										...
										setTreeBlockState(changedBlocks, world, position.add(dir.getXOffset(), height - 5 + hlevel, dir.getZOffset()),
												MCreatorTestinggithub.block.getDefaultState(), bbox);
									}
								}
							}
						}
		...
		private void addVines(IWorld world, BlockPos pos, Set<BlockPos> changedBlocks, MutableBoundingBox bbox) {
			setTreeBlockState(changedBlocks, world, pos, MCreatorTestinggithub.block.getDefaultState(), bbox);
			int i = 5;
		...
		private boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == MCreatorTestinggithub.block.getDefaultState().getBlock()
					|| blockType == MCreatorTestinggithub.block.getDefaultState().getBlock()
					|| blockType == MCreatorTestinggithub.block.getDefaultState().getBlock()
					|| blockType == MCreatorTestinggithub.block.getDefaultState().getBlock();
		}
