...
public class MCreatorFUCKMEINMYASS extends Elementstesting.ModElement {
	@ObjectHolder("testing:fuckmeinmyass")
	public static final ModDimension dimension = null;
	@ObjectHolder("testing:fuckmeinmyass")
	public static final Item block = null;
	@ObjectHolder("testing:fuckmeinmyass_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public MCreatorFUCKMEINMYASS(Elementstesting instance) {
		super(instance, 5);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("fuckmeinmyass"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("testing:fuckmeinmyass")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("testing:fuckmeinmyass"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("testing:fuckmeinmyass"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setRegistryName("fuckmeinmyass"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("fuckmeinmyass_portal");
		}
		...
		public BiomeProviderCustom(World world) {
			...
			for (Biome biome : this.biomes) {
				biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
					{
						carvableBlocks = ImmutableSet.of(Blocks.BUBBLE_COLUMN.getDefaultState().getBlock(),
